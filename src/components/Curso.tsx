        ...
        <section className="py-12 sm:py-16 md:py-20 bg-white text-black">
            <div className="container mx-auto px-6">
                <div className="max-w-[1140px] flex flex-col md:flex-row items-center justify-between mx-auto">
                    ...
                    <div className="relative z-0 flex justify-center md:justify-start items-center w-full md:w-1/2 h-[400px] md:h-[600px] order-1 md:order-1">
                    ...
                    <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left w-full md:w-1/2 max-w-2xl order-2 md:order-2 md:py-0">
                        ...
                        <div className="font-sora text-[#555555] text-base leading-relaxed space-y-4 mb-8">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="text-black font-semibold mb-1">Aulas Teóricas</h4>
                                        <p className="text-sm text-[#666666]">Entenda as raízes e a evolução do estilo Neotraditional. Explore os elementos característicos, as influências históricas e culturais, e as técnicas que tornam este estilo único.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="text-black font-semibold mb-1">Desenho e Decalque</h4>
                                        <p className="text-sm text-[#666666]">Aprenda a criar desenhos autênticos e detalhados, prontos para serem transferidos para a pele. Domine o uso de decalques para garantir precisão e qualidade em suas tatuagens.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="text-black font-semibold mb-1">Técnicas de Tatuagem</h4>
                                        <p className="text-sm text-[#666666]">Desde a configuração da máquina até a escolha das agulhas e tintas, aprenda as técnicas essenciais para tatuar no estilo Neotraditional.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="text-black font-semibold mb-1">Aulas Práticas</h4>
                                        <p className="text-sm text-[#666666]">Acompanhe Olavo em sessões práticas, tatuando do começo ao fim em uma pessoa. Veja de perto como ele aplica suas habilidades e conhecimentos, e tenha a oportunidade de praticar sob sua supervisão.</p>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div className="font-sora text-[#666666] text-base md:text-lg leading-relaxed mb-8">
                            <p>
