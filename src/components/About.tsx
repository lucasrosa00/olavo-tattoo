        ...
        <section className="pb-12 sm:pb-16 md:pb-20 bg-[#0D0D0D] text-white">
            <div className="container mx-auto px-6">
                <div className="max-w-[1140px] flex flex-col md:flex-row items-center justify-between mx-auto">
                    ...
                    {/* Conteúdo (à esquerda no desktop) */}
                    <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left w-full md:w-1/2 max-w-2xl order-2 md:order-1 pt-12 md:py-0">
                    ...
                    <div className="relative z-0 flex justify-center md:justify-end items-center w-full md:w-1/2 h-[400px] md:h-[600px] order-1 md:order-2">
