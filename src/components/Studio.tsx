    ...
    <section className="pb-12 sm:pb-16 md:pb-20 pt-0 sm:pt-16 md:pt-20 bg-[#0D0D0D] text-white">
      <div className="container mx-auto px-6">
              ...
              >
                ...
                <div className="relative aspect-[4/3] rounded-lg overflow-hidden">
                  <Image
                    ...
                    alt={
                      studioImages.find((img) => img.id === selectedImage)?.title || "Studio"
                    }
                    fill
                ...
                <div className="mt-4 text-center">
                  <p className="font-sora text-[#cccccc] text-sm">
                    {studioImages.findIndex((img) => img.id === selectedImage) + 1} de{" "}
                    {studioImages.length}
                  </p>
                </div>
              </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.3 }}
        >
          <p className="font-sora text-[#999999] mb-2">
            Gostou do nosso espaço? Venha nos conhecer pessoalmente!
          </p>
          <p className="font-sora text-[#cccccc] mb-4">
            R. Duque de Caxias, 754 - Centro, Bebedouro - SP, 14701-430
          </p>
